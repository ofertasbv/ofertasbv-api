...
//    @PreAuthorize("hasAuthority('ROLE_CADASTRAR_CATEGORIA') and #oauth2.hasScope('write')")
    public ResponseEntity<Pagamento> create(@Validated @RequestBody Pagamento pagamento, HttpServletResponse response) {
...
//    @PreAuthorize("hasAuthority('ROLE_PESQUISAR_CATEGORIA')")
    public ResponseEntity<Pagamento> update(@PathVariable Long id, @Validated @RequestBody Pagamento pagamento) {
        try {
