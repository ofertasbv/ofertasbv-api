...
//    @PreAuthorize("hasAuthority('ROLE_CADASTRAR_CATEGORIA') and #oauth2.hasScope('write')")
    public ResponseEntity<CaixaFluxoEntrada> create(@Valid @RequestBody CaixaFluxoEntrada caixa, HttpServletResponse response) {
...
//    @PreAuthorize("hasAuthority('ROLE_PESQUISAR_CATEGORIA')")
    public ResponseEntity<CaixaFluxoEntrada> update(@PathVariable Long id, @Valid @RequestBody CaixaFluxoEntrada caixa) {
        try {
